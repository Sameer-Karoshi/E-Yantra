...
def start_simulation(client_id):
	...
	return_code = sim.simxStartSimulation(client_id, sim.simx_opmode_oneshot) # Start simulation
...
def transform_vision_sensor_image(vision_sensor_image, image_resolution):
	...
	try:
		...
		transformed_image = cv2.flip(transformed_image, 1) #### Flip img about Y axis ####
